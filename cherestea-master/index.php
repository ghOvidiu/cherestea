...
<div class="jumbotron jumbotron-fluid" id="welcome_jumbo">
    <div class="container" id="welcome_message">
        ...
        <p class="lead">Cine suntem noi? Am luat fiinta intr-o zi calduroasa de vara, prin 2002, iar de atunci suntem pe piata materialelor de constructii din zona Chitila/Bucuresti. Da, ati citit bine, aproape 20 de ani de activitate intr-un domeniu in care nu este foarte usor sa supravietuiesti, intr-o tara ca a noastra. Timp de 20 ani am pus pe primul loc clientul si apoi pe noi. De ce? Daca un client este multumit inseamna ca se va intoarce la noi sau va recomanda mai departe munca noastra. Am invatat in acesti ani ca profitul nu este pe primul loc, ci clientul.
            In acesti ani nu am uitat, totusi, sa fim si oameni si am ajutat comunitatea cat am putut. In 2012 am contribuit cu cherestea pentru consolidarea spitalului de urgenta Coltea, am ajutat la constructia Petrom City in anul 2010 si  nu am uitat sa ne si distram in acesti ani asa ca am colaborat si cu Princess Club, care se bucura de o podea noua.
            Daca vreti sa ne aflati toata povestea, sa cumparati sau pur si simplu sa stam la „un pahar” de vorba va asteptam la sediul nostru.
        </p>
    </div>
</div>
